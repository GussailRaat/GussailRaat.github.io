...
<style>
.project-list h3 { margin-top: 1.5rem; margin-bottom: 0.5rem; }
.project-list .project-row { display: flex; padding: 0.5rem 0; border-bottom: 1px solid #eee; }
.project-list .project-date { flex: 0 0 200px; color: gray; font-size: 0.9em; padding-top: 0.1rem; }
